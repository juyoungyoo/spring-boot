...
@SpringBootTest
//(classes = { AuthServerConfig.class, TokenController.class }, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
...
public class TokenControllerTest {
    ...
    public void shouldReturnEmptyListOfTokensWhenTokenStoreReturnNull() throws Exception {
        when(tokenStore.findTokensByClientId("myApp")).thenReturn(null);
    ...
    public void shouldReturnNotEmptyListOfTokens() throws Exception {
        when(tokenStore.findTokensByClientId("myApp")).thenReturn(generateTokens(1));
    ...
    public void shouldReturnListOfTokens() throws Exception {
        when(tokenStore.findTokensByClientId("myApp")).thenReturn(generateTokens(10));
